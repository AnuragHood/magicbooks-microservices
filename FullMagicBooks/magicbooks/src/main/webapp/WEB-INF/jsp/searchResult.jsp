...
<div class="container  z-depth-5" id="container">
    ...
    <p class="teal-text text-darken-1 center">Your Search Results:</p>
                                ...
                                <table class="highlight centered ">
                                    ...
                                    <tr>
                                        <td><a class="btn-floating btn-small waves-effect waves-light red"><i
                                                class="material-icons add-to-cart" value ="${fn:escapeXml(item.quantity)}" id="${fn:escapeXml(item.id)}">add</i></a>
                                        </td>
